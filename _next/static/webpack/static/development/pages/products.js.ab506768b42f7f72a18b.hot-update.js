...
})(["transform:", ";margin-left:2em;margin-right:auto;width:0;height:0;border-style:solid;border-width:11px 6px 0px 6px;border-color:", " transparent transparent transparent;border:transparent 1px 1px 1px;", "{display:none;}"], function (p) {
...
})(["display:none;", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;white-space:nowrap;overflow-x:scroll;-webkit-overflow-scrolling:touch;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}> div{cursor:pointer;margin-right:1.5em;font-weight:300;color:", ";&:hover,&.active{color:white;}}}"], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_7__["media"])('desktop'), function (p) {
  return p.theme.colors.main;
});
...
var Header = function Header(_ref2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Wrapper, {
    ...
    alt: "logo-title"
  }), sections && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Triangle, null), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(SectionSelectWrapper, null, sections.map(function (section) {
...
//# sourceMappingURL=products.js.ab506768b42f7f72a18b.hot-update.js.map