...
})(["display:flex;justify-content:space-between;color:white;flex-wrap:wrap;background-color:", ";"], function (props) {
...
})(["width:100%;", "{width:45%;}"], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_4__["media"])('pad'));
...
})(["display:flex;align-items:center;margin-bottom:1em;> img{width:30px;height:30px;margin-right:2em;}> p{line-height:1.2;margin:0;}"]);

var Footer = function Footer() {
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Wrapper, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(ContentWrapper, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_Title__WEBPACK_IMPORTED_MODULE_6__["default"], {
    title: "About us",
    color: "white"
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, "MINGCHI originally was a capacitor equipment company from Taiwan, and now is devoted to producing all kinds of equipments. Having more than 10 years researching and developing experience, we have our own strong and stable ability to customize products with customer\u2019s requirements. Our main supporting and producing factory is in China mainland and another is in Singapore.."), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, "Besides the capacitors equipment, we also provide other design of automatic equipment, such as connector, dolar energy etc., includes any customized requirements. In the future, we will keep renewing our technology and make our products more mature and excellent to solve the problem of life, industry and the words.")), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(ContentWrapper, {
    id: "contact-us"
  ...
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, "5F., No.13, Ln. 122, Wuhua St. Sanchong Dist., New Taipei City 24151, Taiwan (R.O.C.)")), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(IconWrapper, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("img", {
  ...
  }, "hang_tm@hotmail.com"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
    href: "mailto:hangtm@mingchi.tech?subject=[Contact]: ..."
  }, "hangtm@mingchi.tech"), "hangtm@mingchi.tech")), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(IconWrapper, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("img", {
    src: Object(_utils__WEBPACK_IMPORTED_MODULE_5__["getRelativePath"])('/static/icon-mobile.svg')
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, "+886 903568802"))));
};
...
//# sourceMappingURL=index.js.2fb6e73969a3c91e481b.hot-update.js.map