...
})(["position:fixed;display:flex;justify-content:space-between;align-items:center;width:100%;height:55px;padding:12px ", ";z-index:", ";background-color:", ";border-bottom:solid 1px rgba(51,51,51,0.65);transform:translateY(0);transition:all .3s ease-in;", "{height:", ";}", ""], function (props) {
...
})(["svg{height:2em;transform:translateY(5px);}g{path{fill:", ";}}"], function (p) {
  return p.gold ? 'white' : p.theme.colors.main;
});
...
//# sourceMappingURL=index.js.720d00faf0ab16c0e2ad.hot-update.js.map