...
})(["position:fixed;width:100vw;height:100vh;left:0;top:0;background:", ";transition:height 0.5s ease-in-out;z-index:-1;}.mobile-sections-wrapper{display:", ";}.desktop-sections{display:none;}.sections{cursor:pointer;font-weight:300;color:", ";&:hover,&.active{color:white;}}", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;white-space:nowrap;overflow-x:scroll;-webkit-overflow-scrolling:touch;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}.desktop-sections{display:block;margin-right:1.5em;}}"], function (p) {
  return p.theme.colors.black;
}, function (p) {
...
var Header = function Header(_ref2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Wrapper, {
    ...
    className: "mobile-sections-wrapper"
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: "sections desktop-sections",
      key: section.id,
      onClick: function onClick() {
        return scrollTo(section);
      }
...
//# sourceMappingURL=products.js.b0820731f0726f80ac85.hot-update.js.map