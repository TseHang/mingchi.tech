...
})(["display:none;", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;overflow-x:scroll;-webkit-overflow-scrolling:touch;white-space:nowrap;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}> div{cursor:pointer;margin-right:1.5em;font-weight:300;color:", ";&:hover,&.active{color:white;}}}"], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_7__["media"])('desktop'), function (p) {
  return p.theme.colors.main;
});
...
var Header = function Header(_ref2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Wrapper, {
    ...
    alt: "logo-title"
  }), sections && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(SectionSelectWrapper, null, sections.map(function (section) {
...
//# sourceMappingURL=products.js.438b493da16b11321580.hot-update.js.map