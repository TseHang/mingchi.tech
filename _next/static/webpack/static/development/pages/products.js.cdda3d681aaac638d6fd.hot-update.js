...
})(["position:fixed;right:0;top:0;width:0vw;height:0vh;color:", ";background:", ";z-index:", ";transition:all .3s ease-in-out;display:flex;flex-direction:column;align-items:center;justify-content:center;> div{cursor:pointer;display:flex;align-items:center;margin-bottom:1em;min-width:100px;&:hover{color:white;path{fill:white;}}}p{margin:0;font-size:", ";}", ""], function (p) {
...
//# sourceMappingURL=products.js.cdda3d681aaac638d6fd.hot-update.js.map