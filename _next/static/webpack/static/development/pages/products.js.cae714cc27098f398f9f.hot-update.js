...
})(["position:fixed;width:100vw;height:100vh;left:0;top:0;background:", ";transition:height 0.5s ease-in-out;.mobile-sections-wrapper{display:", ";}.desktop-sections-wrapper{display:none;}.sections{cursor:pointer;font-weight:300;color:", ";&:hover,&.active{color:white;}}", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;white-space:nowrap;overflow-x:scroll;-webkit-overflow-scrolling:touch;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}.sections{cursor:pointer;margin-right:1.5em;&:hover,&.active{color:white;}}}"], function (p) {
  return p.theme.colors.black;
}, function (p) {
...
//# sourceMappingURL=products.js.cae714cc27098f398f9f.hot-update.js.map