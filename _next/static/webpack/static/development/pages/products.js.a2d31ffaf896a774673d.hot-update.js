...
})(["transform:", ";transition:transform .3s ease-in-out;cursor:pointer;svg{height:2em;transform:translateY(5px);}"], function (p) {
...
var SmallXsCircle = Object(styled_components__WEBPACK_IMPORTED_MODULE_4__["default"])(SmallCircle).withConfig({
  displayName: "Header__SmallXsCircle",
...
})(["position:fixed;right:0;top:-10vh;width:100vw;height:", ";color:", ";background:", ";z-index:", ";transition:height .5s ease-in-out;display:flex;flex-direction:column;align-items:center;justify-content:center;> div{cursor:pointer;display:flex;align-items:center;margin-bottom:1em;min-width:100px;&:hover{color:white;path{fill:white;}}}p{margin:0;font-size:", ";}"], function (p) {
  return p.open ? '110vh' : '0';
}, function (p) {
...
var Header = function Header() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Wrapper, {
    ...
    src: Object(_utils__WEBPACK_IMPORTED_MODULE_6__["getRelativePath"])('/static/circle.svg'),
    wrapper: "span"
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", null, "Products"))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
    href: "#products"
  }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
    onClick: function onClick() {
      return setOpen(false);
    }
  }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(SmallXsCircle, {
    src: Object(_utils__WEBPACK_IMPORTED_MODULE_6__["getRelativePath"])('/static/circle.svg'),
    wrapper: "span"
...
//# sourceMappingURL=products.js.a2d31ffaf896a774673d.hot-update.js.map