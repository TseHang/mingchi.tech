...
})(["position:fixed;width:100vw;height:100vh;left:0;top:0;background:", ";", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;white-space:nowrap;overflow-x:scroll;-webkit-overflow-scrolling:touch;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}> div{cursor:pointer;margin-right:1.5em;font-weight:300;color:", ";&:hover,&.active{color:white;}}}"], function (p) {
  return p.theme.colors.black;
...
//# sourceMappingURL=products.js.b6795a64d522183fc2c2.hot-update.js.map