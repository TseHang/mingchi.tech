...
})(["display:none;", "{display:flex;flex-wrap:nowrap;margin-right:auto;margin-left:3%;max-width:65%;height:100%;overflow:scroll;> div{cursor:pointer;margin-right:1.5em;font-weight:300;color:", ";&:hover,&.active{color:white;}}}"], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_7__["media"])('desktop'), function (p) {
  return p.theme.colors.main;
});
...
//# sourceMappingURL=products.js.0e0bf482f26f64d7be98.hot-update.js.map