...
})(["height:15em;background:rgba(231,231,231,.3) url(", ") no-repeat center / contain;"], function (p) {
  return p.src;
});
...
})(["display:flex;justify-content:space-between;flex-wrap:wrap;> a{width:47%;text-align:center;margin-bottom:1.5em;", "{width:23%;}}", "{margin:0 10%;}"], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_3__["media"])('pad'), Object(_themes_helper__WEBPACK_IMPORTED_MODULE_3__["media"])('desktop'));
...
//# sourceMappingURL=products.js.835c86600b51b45dae9b.hot-update.js.map