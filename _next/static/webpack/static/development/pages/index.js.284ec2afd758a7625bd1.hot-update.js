...
})(["position:fixed;width:100%;z-index:", ";padding:12px ", ";background-color:", ";"], function (props) {
...
var NavWrapper = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "Header__NavWrapper",
  componentId: "xcop5m-1"
})(["display:flex;justify-content:space-between;align-items:center;width:100%;height:55px;border-bottom:solid 1px rgba(51,51,51,0.65);transform:translateY(0);transition:all 0.3s ease-in;", "{height:", ";}", ""], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_6__["media"])('pad'), function (props) {
  return props.theme.headerHeight;
}, function (p) {
  return p.hideUp && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(["transform:translateY(-200%);"]);
});
...
var Header = function Header() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Wrapper, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(NavWrapper, {
...
//# sourceMappingURL=index.js.284ec2afd758a7625bd1.hot-update.js.map