...
})(["display:none;", "{display:flex;margin-right:auto;margin-left:3%;> div{cursor:pointer;margin-right:2em;font-weight:300;color:", ";&:hover,&.active{color:white;}}}"], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_7__["media"])('desktop'), function (p) {
  return p.theme.colors.main;
});
...
var Header = function Header(_ref2) {
  ...
  var scrollTo = function scrollTo(section) {
    var _getBoundingClientRec = document.getElementById(section.id).getBoundingClientRect(),
        top = _getBoundingClientRec.top;

    var windowOffset = setOpen(false);
...
//# sourceMappingURL=products.js.c2c3640a10c38c331fb9.hot-update.js.map