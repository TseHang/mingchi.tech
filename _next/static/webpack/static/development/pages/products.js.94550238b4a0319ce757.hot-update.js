...
})([".sections{display:none;cursor:pointer;font-weight:300;color:", ";&:hover,&.active{color:white;}}", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;white-space:nowrap;overflow-x:scroll;-webkit-overflow-scrolling:touch;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}.sections{display:block;margin-right:1.5em;}}"], function (p) {
  return p.theme.colors.main;
}, Object(_themes_helper__WEBPACK_IMPORTED_MODULE_7__["media"])('desktop'));
...
//# sourceMappingURL=products.js.94550238b4a0319ce757.hot-update.js.map