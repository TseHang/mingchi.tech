...
})(["transition:transform .3s ease-in-out;transform:", ";margin-left:2em;margin-right:auto;width:0;height:0;border-style:solid;border-width:11px 6px 0px 6px;border-color:", " transparent transparent transparent;border:transparent 1px 1px 1px;", "{display:none;}"], function (p) {
...
})(["position:fixed;width:100vw;height:100vh;left:0;top:0;background:", ";> div{display:", ";cursor:pointer;margin-right:1.5em;font-weight:300;color:", ";&:hover,&.active{color:white;}}", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;white-space:nowrap;overflow-x:scroll;-webkit-overflow-scrolling:touch;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}}"], function (p) {
  return p.theme.colors.black;
}, function (p) {
  return p.open ? 'flex' : 'none';
}, function (p) {
...
var Header = function Header(_ref2) {
  ...
  }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(SectionSelectWrapper, {
    open: true
...
//# sourceMappingURL=products.js.3b3f395c81433c05d7b9.hot-update.js.map