...
})(["position:fixed;right:0;top:", ";width:100vw;height:", ";color:", ";background:", ";z-index:", ";transition:height .5s ease-in-out;display:flex;flex-direction:column;align-items:center;justify-content:center;> div{cursor:pointer;display:flex;align-items:center;margin-bottom:1em;min-width:100px;&:hover{color:white;path{fill:white;}}}p{margin:0;font-size:", ";}"], function (p) {
  return p.open ? 0 : '-100vh';
}, function (p) {
...
//# sourceMappingURL=products.js.26e90fbb66547c177dc2.hot-update.js.map