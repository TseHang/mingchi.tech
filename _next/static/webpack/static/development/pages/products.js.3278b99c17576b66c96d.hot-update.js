...
})(["position:fixed;width:100vw;height:100vh;left:0;top:0;background:", ";transition:height 0.5s ease-in-out;.mobile-sections{display:", ";}.desktop-sections{display:none;}", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;white-space:nowrap;overflow-x:scroll;-webkit-overflow-scrolling:touch;-ms-overflow-style:none;&::-webkit-scrollbar{display:none;}.desktop-sections{cursor:pointer;margin-right:1.5em;font-weight:300;color:", ";&:hover,&.active{color:white;}}}"], function (p) {
  return p.theme.colors.black;
}, function (p) {
  return p.open ? 'block' : 'none';
}, Object(_themes_helper__WEBPACK_IMPORTED_MODULE_7__["media"])('desktop'), function (p) {
  return p.theme.colors.main;
});
...
//# sourceMappingURL=products.js.3278b99c17576b66c96d.hot-update.js.map