...
})(["display:none;", "{display:flex;justify-content:flex-start;align-items:center;margin-right:auto;margin-left:3%;max-width:65%;height:100%;overflow-x:scroll;-webkit-overflow-scrolling:touch;white-space:nowrap;> div{height:100%;cursor:pointer;margin-right:1.5em;font-weight:300;color:", ";&:hover,&.active{color:white;}}}"], Object(_themes_helper__WEBPACK_IMPORTED_MODULE_7__["media"])('desktop'), function (p) {
  return p.theme.colors.main;
});
...
//# sourceMappingURL=products.js.e0fe8be3d9172110d926.hot-update.js.map