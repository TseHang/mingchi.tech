...
})(["position:fixed;right:0;top:0;width:0vw;height:0vh;color:", ";background:", ";z-index:", ";transition:all .2s ease-in-out;display:flex;flex-direction:column;align-items:center;justify-content:center;> div{cursor:pointer;display:flex;align-items:center;margin-bottom:1em;min-width:100px;&:hover{color:white;path{fill:white;}}}p{margin:0;font-size:", ";}", ""], function (p) {
...
//# sourceMappingURL=products.js.6d153cd25e0bcf4892a7.hot-update.js.map